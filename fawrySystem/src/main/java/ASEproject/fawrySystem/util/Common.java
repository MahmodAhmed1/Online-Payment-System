...
public class Common  {
    ...
    public Common()
    {
        ...
        trans.setId();
        trans.setServiceProviderName("Vodafone mobile recharge");

        completeTrans.put(trans.getId(),trans);

        trans1.setAmountPaid(20);
        trans1.setId();
        trans1.setServiceProviderName("Etisalat internet payment");
        
        completeTrans.put(trans1.getId(),trans1);
        
        RefundRequest req=new RefundRequest();
        req.setReqID();
        req.setRelatedService("Vodafone mobile recharge");
        req.setTransID(1);
